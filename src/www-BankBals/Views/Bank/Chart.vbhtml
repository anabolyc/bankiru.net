...
@ModelType BankQuery.Result2
    
@Code
    ViewData("Title") = "График:" + ViewBag.Bank.NameRus + " - " + Model.AggItem.NameRus
...
<script type="text/javascript">
    ...
    @Code
        ...
        For Each item As BankQuery.Data3 In Model.Data
            last = item.Value / IIf(Model.IsRatio, 100.0, 1000000.0)
    ...
    $("#chart").highcharts({
        ...
        title: {
            text: '@ViewBag.Bank.Name - @(Model.AggItem.NameRus)@(IIf(Model.IsRatio, "", ", млрд. руб."))',
        ...
        tooltip: {
            ...
            formatter: function () {
                var s = ""
                s += "1 " + this.x + ": " + this.y.toFixed(2) + '@(IIf(Model.IsRatio, " %", " млрд. руб."))'
